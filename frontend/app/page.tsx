...
export default function Home() {
  ...
  const dedupeSources = (docs: PDFDocument[]): PDFDocument[] => {
    const seen = new Set<string>();
    const unique: PDFDocument[] = [];
        ...
        for (const line of lines) {
          ...
          if (event === 'messages/partial') {
            ...
            if (
              ...
              // Handle documents here (dedupe by source + page)
              lastRetrievedDocsRef.current = dedupeSources(retrievedDocs);
